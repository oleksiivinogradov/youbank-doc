...
![Mint NFT](./../media-assets/web-app/mint-nft.png)
...
![nft-success](./../media-assets/web-app/nft-success.png)

Click on the NFT address to check the status and details.

![nft-contract-details](./../media-assets/web-app/nft-contract-details.png)
